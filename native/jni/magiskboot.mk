# Magiskboot binary makefile by affggh
# Apatch 2.0
...
override CFLAGS :=  $(CFLAGS) -static -Wall -Oz
override CXXFLAGS := $(CXXFLAGS) -static -std=c++2a -stdlib=libc++
override LDFLAGS := $(LDFLAGS) -flto -lpthread -lrt 
...
# -Izopfli/src -Imincrypt/include -Izlib -Ixz/src/liblzma/api

# Bug : zlib bug on cygwin
override LDFLAGS := -lz $(LDFLAGS) 
...
bin/magiskboot: lib/libmagiskboot.a lib/libbase.a lib/libcompat.a lib/libmincrypt.a \
                lib/liblzma.a lib/libbz2.a lib/liblz4.a lib/libzopfli.a lib/libfdt.a
	@mkdir -p `dirname $@`
	@echo -e "\t    LD\t    $@"
...
lib/libmagiskboot.a: $(MAGISKBOOT_OBJ) $(LIBMAGISKBOOT_OBJ)
	@mkdir -p `dirname $@`
	@echo -e "\t    AR\t    $@"
	@ar rcs $@ $^

lib/libcompat.a: $(LIBCOMPAT_OBJ)
	@mkdir -p `dirname $@`
	@echo -e "\t    AR\t    $@"
	@ar rcs $@ $^
